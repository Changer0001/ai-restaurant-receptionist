...
from app.api.endpoints import auth, calls, faqs, hours, knowledge, reservations, restaurants
...
router.include_router(calls.router, prefix="/restaurants", tags=["Calls"])
router.include_router(reservations.router, prefix="/restaurants", tags=["Reservations"])
